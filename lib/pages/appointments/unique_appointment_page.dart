...
class _UAppointmentPageState extends State<UAppointmentPage> {
  PosicaoFilaService posicaoFilaService = PosicaoFilaService();
  ...
  Future<void> _callbackLoadingScreen() async {
    ...
    await desmarcarConsulta.desmarcar(widget.data['codigo_medico'],
        widget.data['dia_mes_ano'], widget.data['codigo_paciente']);
